...
$SQLquery = "INSERT INTO sessions VALUES ((SELECT IFNULL(max(idsessions)+1,1) from (Select idsessions from sessions) as idsessions),'$specId', '$timeStart','$timeFinish', '$pathId','$iddiagnosis','$lechenie','$sledSpec'), INSERT INTO PatientsDiagnosis VALUES ('$pathId','$iddiagnosis')";
