<html>
 ...
 <body>
	...
	printf('<P>Связь пациент-диагноз(чтобы потом использовать в карте пациента),
		в идеале этой таблицы не будет на сайте, только в базе данных, но в данном этапе разработки решили выставить на показ все таблицы дб, тут инфа не вводится а автоматически сохранятся после сеанса</P>');
	include('config.php');	
