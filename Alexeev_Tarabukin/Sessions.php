<html>
 ...
 <body>
	...
	{
		printf('<P>Сеанс %d у специалиста %s %s %s c %s до %s пациента %s %s %s с диагнозом %s  Назначено лечение: %s , следующий врач: %s </P>',$result[0],$result[1],$result[2],$result[3],$result[4],$result[5],$result[6],$result[7],$result[8],$result[9],$result[10],$result[11]);
	}
